...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::narrative_media::narrative_media_get,
            commands::narrative_media::narrative_media_policy,
            commands::narrative_media::narrative_media_export,
            commands::narrative_media::narrative_media_preview,
            commands::narrative_media::narrative_media_import,
            commands::narrative_media::narrative_media_audition,
            commands::narrative_locale::narrative_locale_get,
            commands::narrative_locale::narrative_locale_policy,
            commands::narrative_locale::narrative_locale_export,
            commands::narrative_locale::narrative_locale_preview,
            commands::narrative_locale::narrative_locale_import,
            commands::narrative_locale::narrative_locale_approve,
            ...
            commands::narrative_variants::narrative_variants_get,
            commands::narrative_variants::narrative_variants_plan,
            commands::narrative_variants::narrative_variants_materialize,
            commands::narrative_variants::narrative_variants_build,
            commands::narrative_build::narrative_build_plan,
            commands::narrative_build::narrative_build_status,
            commands::narrative_build::narrative_build_list,
            commands::narrative_build::narrative_build_start,
            ...
            commands::narrative_world::narrative_world_get,
            ...
            commands::narrative_text::narrative_text_create,
            commands::narrative_text::narrative_text_save,
            commands::narrative_text::narrative_text_delete,
            commands::narrative_text::narrative_text_diagnostics,
            commands::narrative::narrative_scene_get,
            commands::narrative::narrative_scene_create,
            commands::narrative::narrative_scene_rename,
            commands::narrative::narrative_scene_delete,
            commands::narrative::narrative_scene_save,
            commands::narrative::narrative_text_written,
            commands::narrative::narrative_state_get,
