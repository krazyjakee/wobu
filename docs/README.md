...
| [34 — Dependency Tracking](34-narrative-dependencies.md) | Field and query dependencies, fingerprints, Why affected, the rebuildable index and the layout exclusion |
