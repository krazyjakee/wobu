...
| [N4 — Incremental builds and narrative analysis](https://github.com/krazyjakee/wobu/milestone/18) | **In progress** | Rebuild affected content safely, inspect bounded coverage and Flow diagnostics, and author the DSL. [Dependency tracking](34-narrative-dependencies.md) reports and explains affected lines; planning the rebuild is next. | [#168](https://github.com/krazyjakee/wobu/issues/168)–[#172](https://github.com/krazyjakee/wobu/issues/172), [#189](https://github.com/krazyjakee/wobu/issues/189) |
