...
No provider call is made by discovery or organization. N5 engine adapters remain excluded. Affected-line tracking (#168) is answered by the [dependency index](34-narrative-dependencies.md) rather than by this projection, and full workspace/Flow acceptance is not implied by this library checkpoint. Supporting-text assets (#167) are authored in the separate [Text library](33-narrative-supporting-text.md) and are not in this index.
