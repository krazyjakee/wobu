...
No provider call is made by discovery or organization. N5 engine adapters remain excluded. Automatic affected-generation tracking (#168) and full workspace/Flow acceptance are not implied by this library checkpoint. Supporting-text assets (#167) are authored in the separate [Text library](33-narrative-supporting-text.md) and are not in this index.
